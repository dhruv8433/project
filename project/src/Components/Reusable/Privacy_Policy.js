...
const Privacy_Policy = () => {
  return (
    <div>
      ...
      <h2>Privacy</h2> <br/>
        <p>
          At eDemand, accessible from https://edemand.wrteam.me, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by eDemand and how we use it.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          shared and/or collect in eDemand. This policy is not applicable to any
        ...
        <br /><h2>Information we collect</h2><br />
        <p>
        ...
        <br /><h2>How we use your information</h2><br />
        <p>We use the information we collect in various ways, including to:</p>
        <br />
        <ul>
          <br /><li>Provide, operate, and maintain our website</li><br />
          ...
          <br /><li>Send you emails</li><br /><li>Find and prevent fraud</li><br />
        </ul>
        <br /><h2>Log Files</h2><br />
        <p>
          eDemand follows a standard procedure of using log files. These files
        ...
        <br /><h2>Advertising Partners Privacy Policies</h2><br />
        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of eDemand.
        </p>
        <br />
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on eDemand, which are sent
        ...
        <br />
        <p>
          Note that eDemand has no access to or control over these cookies that
          are used by third-party advertisers.
        </p>
        <br /><h2>Third Party Privacy Policies</h2><br />
        <p>
          eDemand's Privacy Policy does not apply to other advertisers or
        ...
        <br />
        <p>
          eDemand does not knowingly collect any Personal Identifiable
