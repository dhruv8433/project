        ...
        <div>
            <Container maxWidth={"lg"} sx={{ mt: 2, mb: 2 }}>
                ...
                <p>
                    ...
                    shall manage your use of our website, edemand accessible at edemand.
                </p>
                <br />
                <p>
                    ...
                    Terms And Conditions Sample Te.
                </p>
                <br />
                <p>
                ...
                <p>
                    Other than the content you own, under these Terms, edemand and/or its
                ...
                <br /><h2>Restrictions</h2><br />
                <p>You are specifically restricted from all of the following:</p><br />
                <ul>
                    <br /><li>publishing any Website material in any other media;</li><br />
                    <li>
                        selling, sublicensing and/or otherwise commercializing any Website
                        material;
                    </li>
                    <br /><li>publicly performing and/or showing any Website material;</li>
                    <br />
                    <li>
                ...
                <p>
                    ...
                    and edemand may further restrict access by you to any areas of this
                ...
                <br /><h2>Your Content</h2><br />
                <p>
                    In these Website Standard Terms and Conditions, \"Your Content\" shall
                    mean any audio, video text, images or other material you choose to
                    display on this Website. By displaying Your Content, you grant edemand
                ...
                <p>
                    ...
                    third-party's rights. edemand reserves the right to remove any of Your
                    Content from this Website at any time without notice.
                </p>
                <br /><h2>No warranties</h2><br />
                <p>
                    This Website is provided \"as is,\" with all faults, and edemand
                ...
                <p>
                    In no event shall edemand, nor any of its officers, directors and
                    ...
                    under contract. &nbsp;edemand, including its officers, directors and
                ...
                <p>
                    You hereby indemnify to the fullest extent edemand from and against
                ...
                <br /><h2>Severability</h2><br />
                <p>
                    If any provision of these Terms is found to be invalid under any
                    applicable law, such provisions shall be deleted without affecting the
                    remaining provisions herein.
                </p>
                <br /><h2>Variation of Terms</h2><br />
                <p>
                    edemand is permitted to revise these Terms at any time as it sees fit,
                    and by using this Website you are expected to review these Terms on a
                    regular basis.
                </p>
                <br /><h2>Assignment</h2><br />
                <p>
                    The edemand is allowed to assign, transfer, and subcontract its rights
                ...
                <br /><h2>Entire Agreement</h2><br />
                <p>
                    These Terms constitute the entire agreement between edemand and you in
                    relation to your use of this Website, and supersede all prior
                    agreements and understandings.
                </p>
                <br /><h2>Governing Law &amp; Jurisdiction</h2><br />
                <p>
